                    ...
                    {isSignedIn ? (
                        <>
                            ...
                            <Link href="/generate-program" className='flex items-center gap-1.5 text-sm hover:text-primary transition-colors'>
                                <DumbbellIcon size={16} /><span>Generate</span>
                            </Link>
                            ...
                            <Button asChild variant="outline" className='ml-2 border-primary/50 text-primary hover:text-white hover:bg-primary/10'><Link href="/generate-program">Get Started</Link></Button>
                            <UserButton />
                        </>
                    ) : (
                        <>
